...
const DinaTimeline = ({ language = 'en' }) => {
  ...
  const timelineEvents = [
    ...
    },
    {
      ...
      title: {
        en: 'Wiesenthal Begins Hunt',
        es: 'Wiesenthal Inicia Caza',
        pt: 'Wiesenthal Inicia Caça',
        de: 'Wiesenthal Beginnt Jagd',
      },
      description: {
    ...
    },
    {
      ...
      icon: '⚖️',
      significance: {
        en: 'Legal basis for DINA prosecutions',
        es: 'Base legal para enjuiciamientos DINA',
        pt: 'Base legal para processos DINA',
        de: 'Rechtsgrundlage für DINA-Verfolgungen',
      },
    },
    {
      year: 1967,
    ...
    },
    {
      year: 1973,
      date: {
        en: 'September 11, 1973',
        es: '11 de Septiembre 1973',
        pt: '11 de Setembro 1973',
        de: '11. September 1973',
      },
      title: {
        en: 'Pinochet Coup',
        es: 'Golpe de Pinochet',
        pt: 'Golpe de Pinochet',
        de: 'Pinochet-Putsch',
      },
      description: {
    ...
    },
    {
      ...
      title: {
        en: 'Operation Condor Launched',
        es: 'Operación Cóndor Lanzada',
        pt: 'Operação Condor Lançada',
        de: 'Operation Condor Gestartet',
      },
      description: {
    ...
    },
    {
      year: 1976,
      date: {
        en: 'September 21, 1976',
        es: '21 de Septiembre 1976',
        pt: '21 de Setembro 1976',
        de: '21. September 1976',
      },
      title: {
        en: 'Letelier Assassination',
        es: 'Asesinato de Letelier',
        pt: 'Assassinato de Letelier',
        de: 'Letelier-Attentat',
      },
      description: {
    ...
    },
    {
      ...
      title: {
        en: 'Dictatorship Ends',
        es: 'Dictadura Termina',
        pt: 'Ditadura Termina',
        de: 'Diktatur Endet',
      },
      description: {
    ...
    },
    {
      ...
      title: {
        en: 'Operation Last Chance',
        es: 'Operación Última Oportunidad',
        pt: 'Operação Última Chance',
        de: 'Operation Letzte Chance',
      },
      description: {
      ...
      icon: '⏰',
      significance: {
        en: 'DINA crimes (52 years old) WELL WITHIN prosecution window',
        es: 'Crímenes DINA (52 años) BIEN DENTRO de ventana de enjuiciamiento',
        pt: 'Crimes DINA (52 anos) BEM DENTRO da janela de processo',
        de: 'DINA-Verbrechen (52 Jahre) GUT INNERHALB des Verfolgungsfensters',
      },
    },
    {
      year: 2005,
      ...
      title: {
        en: 'Contreras Convicted',
        es: 'Contreras Condenado',
        pt: 'Contreras Condenado',
        de: 'Contreras Verurteilt',
      },
      description: {
    ...
    },
    {
      ...
      title: {
        en: 'DINA Documentation System',
        es: 'Sistema de Documentación DINA',
        pt: 'Sistema de Documentação DINA',
        de: 'DINA-Dokumentationssystem',
      },
      description: {
      ...
      icon: '🐾',
      significance: {
        en: 'Current system - International hunt operation active',
        es: 'Sistema actual - Operación de caza internacional activa',
        pt: 'Sistema atual - Operação de caça internacional ativa',
        de: 'Aktuelles System - Internationale Jagdoperation aktiv',
      },
    },
  ];
    ...
    <div className="dina-timeline">
      ...
      <div className="timeline-footer">
        <p className="timeline-message">
          ⚖️{' '}
          {language === 'es'
            ? 'El tiempo no borra los crímenes de lesa humanidad'
            : language === 'pt'
              ? 'O tempo não apaga crimes contra a humanidade'
              : language === 'de'
                ? 'Zeit löscht Verbrechen gegen die Menschlichkeit nicht aus'
                : 'Time does not erase crimes against humanity'}
        </p>
        <p className="neko-signature">🐾 *purrs in historical justice* 😻⚖️</p>
      </div>
    </div>
  );
};
