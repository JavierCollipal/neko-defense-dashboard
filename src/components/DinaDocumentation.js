...
function DinaDocumentation() {
  ...
  const dinaAgentsDatabase = [
    {
      ...
      researchCapability:
        'Strategic intelligence, torture coordination, international operations, CIA liaison',
      workCapability:
        'Full command authority over all DINA operations, cross-border assassination planning, Operation Condor coordination',
      legalStatus: {
        convicted: true,
      ...
      significance:
        'One of most convicted agents in Latin American history. Worked for CIA and received payments.',
      tags: [
        'DINA Chief',
    ...
    },
    {
      ...
      researchCapability:
        "Intelligence documentation, detainee records management, Contreras' personal secretary access to classified operations",
      workCapability:
        'Administrative control of Lautaro Brigade operations, coordination of kidnappings, victim processing and documentation',
      legalStatus: {
        convicted: false,
        currentStatus:
          'IMPRISONED IN AUSTRALIA since 2019 - Fighting Extradition',
        charges:
          '7 counts aggravated kidnapping (Reynalda Pereira, Fernando Navarro, Lincoyán Berríos, Horacio Cepeda, Juan Fernando Ortiz, Héctor Véliz, Víctor Díaz)',
        extraditionStatus:
          'Australian Federal Court rejected appeal July 2025. Next High Court hearing March 2025.',
      ...
      significance:
        "Most prominent DINA agent currently evading Chilean justice. May be 'dozens more DINA agents in Australia who lied on original migration applications.'",
      tags: [
        'AT LARGE',
        'EXTRADITION CASE',
        'UNPROSECUTED',
    ...
    },
    {
      ...
      researchCapability:
        'Torture techniques specialist, interrogation methods, forced disappearance logistics, Villa Grimaldi operations',
      workCapability:
        'Field operations commander, torture execution, kidnapping operations, death squad coordination, Operation Colombo implementation',
      legalStatus: {
        convicted: true,
        ...
        recentConvictions:
          'February 2024: Additional 20 years for Operation Colombo (total now 1,047 years)',
      },
      crimesAccused: [
      ...
      significance:
        'One of the most convicted DINA torturers. Known for sadistic torture methods.',
    ...
    },
    {
      ...
      status: 'CONVICTED - IMPRISONED',
      researchCapability:
        'International intelligence networks, Operation Condor coordination, foreign assassination planning, European connections',
      workCapability:
        'External operations command, cross-border assassination execution, diplomatic cover operations, multinational coordination with Argentine/Uruguayan services',
      legalStatus: {
        convicted: true,
        currentStatus: 'SERVING SENTENCE',
      ...
      verificationStatus: 'CONVICTED',
      significance:
        "Key figure in DINA's international operations. Italian warrant outstanding.",
      tags: [
        'CONVICTED',
        'IMPRISONED',
        'OPERATION CONDOR',
    ...
    },
    {
      ...
      status: 'CONVICTED - IMPRISONED',
      researchCapability:
        'Strategic operations planning, DINA infrastructure management, international assassination coordination, Villa Grimaldi oversight',
      workCapability:
        'Deputy commander authority, operational planning for Letelier assassination, Carmelo Soria murder coordination, direct reporting to Contreras',
      legalStatus: {
        convicted: true,
      ...
      verificationStatus: 'CONVICTED',
      significance:
        "First military officer imprisoned at Punta Peuco. Contreras' right-hand man.",
    ...
    },
    {
      ...
      status: 'DECEASED - CONVICTED',
      researchCapability:
        'Mass torture facility management, psychological torture methods, execution protocols, Caravan of Death operations',
      workCapability:
        'Villa Grimaldi command (4,500+ detainees processed), torture center operations, mass execution coordination, 240+ deaths at single facility',
      legalStatus: {
        convicted: true,
      ...
      verificationStatus: 'CONVICTED',
      significance:
        'One of most sanguinary DINA members. Villa Grimaldi under his command was worst torture center.',
      tags: [
        'CONVICTED',
        'DECEASED',
        'VILLA GRIMALDI COMMANDER',
        'CARAVAN OF DEATH',
      ],
    },
    {
      ...
      status: 'DECEASED - CONVICTED',
      researchCapability:
        'Extreme interrogation techniques, psychological torture, forced disappearance logistics, informant identification',
      workCapability:
        '100+ forced disappearances, direct torture execution, brutal interrogations, Villa Grimaldi operations, Londres 38 work',
      legalStatus: {
        convicted: true,
      ...
      verificationStatus: 'CONVICTED',
      significance:
        'Known for extreme brutality in interrogations. Involved in over 100 disappearances.',
    ...
    },
    {
      ...
      researchCapability:
        'Sexual torture methods, dog training for assault, psychological warfare, female torturer training, Venda Sexy operations',
      workCapability:
        'Venda Sexy command, 27+ forced disappearances from facility, trained 70 female torturers, specialized in sexual violence and animal-assisted torture',
      legalStatus: {
        convicted: false,
      ...
      significance:
        '⚠️ ONE OF WORST CASES OF IMPUNITY! Never prosecuted despite heinous crimes. Became known only after 1981 assassination attempt.',
      tags: [
        'NEVER PROSECUTED',
        'DECEASED',
        'IMPUNITY',
  ...
  const calculateWantedStats = () => {
    const dataSource =
      perpetrators.length > 0 ? perpetrators : dinaAgentsDatabase;
    ...
    return {
      ...
      imprisoned: dataSource.filter(
        (a) => a.status === 'CONVICTED - IMPRISONED'
      ).length,
      deceased: dataSource.filter((a) => a.status?.includes('DECEASED')).length,
      unprosecuted: dataSource.filter(
        (a) => !a.legalStatus?.convicted && !a.status?.includes('DECEASED')
      ).length,
      neverProsecuted: dataSource.filter((a) =>
        a.legalStatus?.prosecution?.includes('NEVER')
      ).length,
    };
  };
  ...
  const fetchDinaData = async () => {
    try {
      ...
      console.log(
        '🔍 [DinaDoc] Fetching DINA data from API, nyaa~ | Language:',
        userLang
      );
      ...
      try {
        ...
        console.warn(
          '⚠️ [DinaDoc] Stats fetch failed, using defaults:',
          statsError.message
        );
        ...
        setStats({
          ...
          perpetrators: {
            ...
            convicted: dinaAgentsDatabase.filter(
              (a) => a.legalStatus?.convicted
            ).length,
            unprosecuted: dinaAgentsDatabase.filter(
              (a) => !a.legalStatus?.convicted
            ).length,
          },
        });
      ...
      try {
        ...
        const perpsResponse = await fetch(
          `${API_URL}/dina/perpetrators?lang=${userLang}`,
          {
        ...
        if (perpsData.success && perpsData.data && perpsData.data.length > 0) {
          console.log(
            `✅ [DinaDoc] Loaded ${perpsData.data.length} perpetrators from API`
          );
          setPerpetrators(perpsData.data);
        } else {
          console.warn(
            '⚠️ [DinaDoc] No perpetrators from API, using hardcoded database'
          );
          setPerpetrators(dinaAgentsDatabase);
        }
      } catch (perpsError) {
        console.warn(
          '⚠️ [DinaDoc] Perpetrators fetch failed, using hardcoded database:',
          perpsError.message
        );
      ...
      setStats({
        ...
        perpetrators: {
          total: dinaAgentsDatabase.length,
          convicted: dinaAgentsDatabase.filter((a) => a.legalStatus?.convicted)
            .length,
          unprosecuted: dinaAgentsDatabase.filter(
            (a) => !a.legalStatus?.convicted
          ).length,
        ...
        <div className="dina-stats-enhanced">
          <div className="stats-row-primary">
            ...
            <div className="stat-box warning">
              <div className="stat-value">
                {stats.perpetrators?.unprosecuted || 0}
              </div>
            ...
            <div className="stat-category victims-total">
              ...
              <div className="stat-breakdown">
                <div className="stat-item large">
                  ~30,000 <span>Total Victims</span>
                </div>
                <div className="stat-item">
                  27,255 <span>Tortured</span>
                </div>
                <div className="stat-item">
                  2,279 <span>Executed</span>
                </div>
                <div className="stat-item">
                  957 <span>Disappeared</span>
                </div>
              </div>
            </div>
            ...
            <div className="stat-category dina-specific highlight">
              ...
              <div className="stat-breakdown">
                <div className="stat-item critical">
                  2,279 <span>Murders</span>
                </div>
                <div className="stat-item critical">
                  957 <span>Forced Disappearances</span>
                </div>
                <div className="stat-item">
                  4,500+ <span>Villa Grimaldi Detainees</span>
                </div>
                <div className="stat-item">
                  1,100+ <span>Londres 38 Detainees</span>
                </div>
              </div>
              <p className="stat-note">
                💀 DINA responsible for MAJORITY of regime's crimes in first 3
                years
              </p>
            </div>
          </div>
            ...
            <div className="overview-cards">
              <div className="overview-card mission-card">
                ...
                <p>
                  ...
                  through evidence-based prosecution. Following the Simon
                  Wiesenthal Nazi-hunting precedent.
                </p>
              </div>
              ...
              <div className="overview-card scope-card">
                <h3>📍 SCOPE</h3>
                <p>
                  DINA operated 1973-1977 across Chile and internationally
                  through Operation Condor. Documented: Torture centers,
                  perpetrators, victims, and international crimes.
                </p>
              </div>
        ...
        {viewMode === 'wanted' && (
          <div className="wanted-agents-view">
            ...
            <p className="wanted-subtitle">
              Comprehensive database of documented DINA agents - Updated October
              2025
            </p>
            ...
            <div className="wanted-agents-comprehensive">
              ...
              <p className="database-note">
                Following Simon Wiesenthal Nazi-hunting precedent: NO statute of
                limitations for crimes against humanity, nyaa~!
              </p>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="agent-preview">
                        ...
                        {agent.alias && (
                          <div className="agent-alias-modern">
                            "{agent.alias}"
                          </div>
                        )}
                      ...
                      {isExpanded && (
                        ...
                        >
                          ...
                          <div className="detail-section-modern legal-section">
                            ...
                            <div className="legal-grid">
                              ...
                              <div className="legal-item">
                                ...
                                {agent.legalStatus?.currentStatus}
                              </div>
                          ...
                          {/* Notable Operations */}
                          {agent.notableOperations &&
                            agent.notableOperations.length > 0 && (
                              <div className="detail-section-modern">
                          ...
                          {agent.significance && (
                            <div
                              className={`detail-section-modern significance-section ${agent.significance.includes('⚠️') ? 'critical-significance' : ''}`}
                            >
                              <h4>🎯 Significance</h4>
              ...
              <div className="wanted-context-section">
                ...
                <div className="context-card">
                  ...
                  <p>
                    Following Nazi-hunter Simon Wiesenthal's methodology:
                    Systematic documentation, evidence preservation, and pursuit
                    of justice regardless of time elapsed.
                  </p>
                </div>
                <div className="context-card">
                  ...
                  <p>
                    Crimes against humanity have NO statute of limitations. Any
                    country can prosecute. Current focus: Adriana Rivas
                ...
                <div className="context-card">
                  ...
                  <p>
                    In 2008, the Chilean Army presented a list of 1,097 DINA
                    agents to Judge Alejandro Solís. Of these, hundreds have
                    been prosecuted, but many remain unpunished.
                  </p>
                </div>
                <div className="context-card critical">
                  <h4>⚠️ Agents in Australia</h4>
                  <p>
                    Adriana Rivas case suggests "dozens more DINA agents in
                    Australia who lied on original migration applications."
                    Investigation ongoing, desu~!
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="perpetrators-list">
            ...
            {perpetrators.length === 0 ? (
              <div className="no-data">
                No perpetrators documented yet, desu!
              </div>
            ) : (
              <div className="perp-grid">
                {perpetrators.map((perp, index) => (
                  ...
                  >
                    ...
                    <div
                      className={`perp-status ${perp.legalStatus?.convicted ? 'convicted' : 'unprosecuted'}`}
                    >
          ...
          <div className="torture-centers-view">
            ...
            <div className="centers-grid">
              <div className="center-card villa-grimaldi">
                ...
                <div className="center-header-info">
                  <span className="center-significance">
                ...
                <div className="center-stats">
                  <div className="center-stat">
                    📍 Location:{' '}
                    <strong>Av. José Arrieta 8401, Peñalolén, Santiago</strong>
                  </div>
                  <div className="center-stat">
                    📅 Period: <strong>Mid-1974 to Mid-1978</strong>
                  </div>
                  <div className="center-stat">
                    👥 Detainees: <strong>~4,500 people</strong>
                  </div>
                  <div className="center-stat critical">
                    💀 Killed/Disappeared: <strong>240+</strong>
                  </div>
                </div>
                <div className="center-current-status success">
                  ✅ NOW: <strong>Parque por la Paz</strong> (Peace Park
                ...
                <div className="torture-methods">
                  ...
                  <ul>
                    <li>
                      ⚡ <strong>La Parrilla</strong> (The Grill) - Electric
                      shock metal bed
                    </li>
                    <li>
                      ⚡ Electric shock to lips, genitals, sensitive areas
                    </li>
                    <li>💧 Waterboarding and near-drowning</li>
                    <li>🧠 Psychological torture and mock executions</li>
                  </ul>
                </div>
                <div className="center-commander">
                  Commander:{' '}
                  <strong>Colonel Manuel Contreras (DINA chief)</strong>
                </div>
              </div>
              ...
              <div className="center-card londres-38">
                ...
                <div className="center-header-info">
                  <span className="center-significance">
                    ⭐ FIRST DINA DETENTION CENTER
                  </span>
                </div>
                <div className="center-stats">
                  <div className="center-stat">
                    📍 Location: <strong>Londres 38, Downtown Santiago</strong>
                  </div>
                  <div className="center-stat">
                    📅 Period: <strong>September 1973 - December 1974</strong>
                  </div>
                  <div className="center-stat">
                    👥 Detainees: <strong>~1,100 people</strong>
                  </div>
                  <div className="center-stat critical">
                    💀 Executed:{' '}
                    <strong>94 (including 2 pregnant women)</strong>
                  </div>
                </div>
                <div className="center-current-status success">
                  ✅ NOW: <strong>Memorial & Human Rights Center</strong> - Open
                  to public
                </div>
              ...
              <div className="center-card other-centers">
                ...
                <div className="center-list">
                  <div className="center-list-item">
                    ...
                    <p>
                      📍 Santiago | 📅 1974-1975 | Major interrogation center
                    </p>
                  </div>
                  <div className="center-list-item">
                    <h4>🏢 Cuatro Alamos</h4>
            ...
            <div className="centers-network-info">
              ...
              <p>
                ...
                centers across Chile. These facilities were used for:
              </p>
              <ul>
              ...
              <p className="memorial-note">
                ...
                honor the victims and preserve historical memory, desu! 🕊️
              </p>
            </div>
          </div>
        )}
        ...
        {viewMode === 'international' && (
          <div className="international-crimes-view">
            ...
            <div className="crimes-timeline">
              <div className="crime-card letelier-crime">
                ...
                <div className="crime-victims">
                  ...
                  <ul>
                    <li>
                      <strong>Orlando Letelier</strong> - Chilean diplomat,
                      former Foreign Minister under Allende
                    </li>
                    <li>
                      <strong>Ronni Karpen Moffitt</strong> - US citizen,
                      American colleague, innocent bystander
                    </li>
                  </ul>
                </div>
                <div className="crime-method">
                  <strong>Method:</strong> 🚗💣 Car bomb planted in Sheridan
                ...
                <div className="crime-prosecution success">
                  <strong>⚖️ Prosecution:</strong> Manuel Contreras convicted
                  1995 → Sentenced 7 years prison (served until 2001)
                </div>
                <div className="crime-significance">
                  <strong>🎯 Significance:</strong> International terrorism on
                  US soil! First major conviction of Contreras. Proved DINA
                  operated globally.
                </div>
              </div>
              ...
              <div className="crime-card prats-crime">
                ...
                <div className="crime-victims">
                  ...
                  <ul>
                    <li>
                      <strong>General Carlos Prats</strong> - Chilean Army
                      Commander-in-Chief (Pinochet's predecessor)
                    </li>
                    <li>
                      <strong>Sofía Cuthbert</strong> - His wife
                    </li>
                  </ul>
                </div>
                <div className="crime-method">
                ...
                <div className="crime-prosecution success">
                  ...
                  <strong>2 LIFE SENTENCES</strong> (June 30, 2008)
                </div>
                <div className="crime-significance">
                  <strong>🎯 Significance:</strong> Operation Condor
                  cross-border assassination. Eliminated Pinochet's military
                  rival in exile. Shows Argentina-Chile DINA cooperation.
                </div>
              </div>
              ...
              <div className="crime-card leighton-crime">
                ...
                <div className="crime-victims">
                  ...
                  <ul>
                    <li>
                      <strong>Bernardo Leighton</strong> - Former Chilean Vice
                      President, Christian Democrat leader
                    </li>
                    <li>
                      <strong>Anita Leighton</strong> - His wife
                    </li>
                  </ul>
                </div>
                <div className="crime-method">
                ...
                <div className="crime-prosecution success">
                  ...
                  Contreras & Raúl Iturriaga <strong>in absentia</strong> (18
                  years each, 1995)
                </div>
                <div className="crime-significance">
                  <strong>🎯 Significance:</strong> Proves European reach of
                  DINA terror! International warrants issued. Shows no continent
                  was safe from DINA operations.
                </div>
              </div>

              <div className="crime-card condor-network">
                <div className="crime-location">
                  🌍 OPERATION CONDOR - MULTINATIONAL
                </div>
                <h3>🦅 Cross-Border State Terrorism Network</h3>
                <div className="crime-date">
                  📅 Founded: November 28, 1975, Santiago, Chile
                </div>
                ...
                <div className="crime-victims">
                  ...
                  <ul>
                    <li>
                      <strong>Zelmar Michelini</strong> - Uruguayan former MP
                      (assassinated Buenos Aires)
                    </li>
                    <li>
                      <strong>Héctor Gutiérrez Ruiz</strong> - Uruguayan former
                      MP (assassinated Buenos Aires)
                    </li>
                    <li>
                      <strong>Juan José Torres</strong> - Former Bolivian
                      president (assassinated Buenos Aires)
                    </li>
                  </ul>
                </div>
                <div className="crime-significance">
                  <strong>🎯 Significance:</strong> Coordinated international
                  state terrorism. Dictatorships hunted dissidents across
                  borders. Dozens of cross-border assassinations documented.
                </div>
              </div>
              ...
              <div className="crime-card cia-connection">
                ...
                <div className="cia-info">
                  ...
                  <p>
                    ...
                    operations. Intelligence sharing between CIA and DINA.
                    Questions about US knowledge of international
                    assassinations.
                  </p>
                </div>
              </div>
            ...
            <div className="contreras-final-record">
              ...
              <p className="contreras-subtitle">
              ...
              <div className="details-content">
                ...
                <div className="detail-section">
                  ...
                  {selectedPerp.organization &&
                    selectedPerp.organization.length > 0 && (
                      <p>
                ...
                <div className="detail-section">
                  ...
                  <p>
                    ...
                    {selectedPerp.legalStatus?.currentStatus || 'Unknown'}
                  </p>
                </div>
