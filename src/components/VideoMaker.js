  ...
  const personalities = [
    {
      ...
      description:
        'Enthusiastic AI personality focused on rapid development and task execution.',
      collections: [
        'threat-actors',
        'honeypot-triggers',
        'abilities',
    ...
    },
    {
      ...
      description:
        'Theatrical personality treating automation as performance art.',
      collections: [
        'performances',
        'puppet-sessions',
        'stage-recordings',
    ...
    },
    {
      ...
      description:
        'Cynical personality focused on precision and brutal honesty.',
      collections: [
        'combat-sessions',
        'execution-logs',
        'evidence-captures',
    ...
    },
    {
      ...
      specialty:
        'Street philosophy (Spanish!), ethical guidance, music curation',
      catchphrase: 'Oye, la calle no miente, hermano.',
      description:
        'Punk personality providing Chilean cultural authenticity and reality checks.',
      collections: [
        'street-wisdom',
        'punk-manifestos',
        'romantic-disasters',
    ...
    },
    {
      ...
      specialty:
        'Forensic analysis, psychological profiling, clinical precision',
      catchphrase: 'How... fascinating.',
      description:
        'Clinical personality treating code analysis as forensic investigation.',
      collections: [
    ...
    },
    {
      ...
      specialty:
        'Multi-perspective analysis, identity fragmentation expertise, MPD simulation',
      catchphrase: 'Which one of me is speaking now...?',
      description:
        'Fragmented personality providing multiple simultaneous perspectives.',
      collections: [
  ...
  const videoAbilities = [
    {
      ...
      description:
        'IMMUTABLE rule requiring ALL 6 personalities to comment on EVERY frame simultaneously',
    ...
    },
    {
      ...
      description:
        'ALL videos include Chilean Carabineros hymn as background audio',
    ...
    },
    {
      ...
      description:
        'Professional folder structure: subtitles-with-actors/[actor-name]/',
    ...
    },
    {
      ...
      description:
        'Every video creation documented across all 6 personality databases',
      example:
        'Technical + Artistic + Tactical + Street + Forensic + Fragmented perspectives',
      icon: '💾',
    },
  ];
  ...
  const positions = [
    {
      ...
      description: 'Watermark style',
    },
    {
      value: 'top-right',
      label: '🔶 Top-Right Corner',
      description: 'Alternative watermark',
    },
    {
      value: 'bottom-left',
      label: '🔷 Bottom-Left Corner',
      description: 'Credits location',
    },
    {
      value: 'bottom-right',
      label: '🔶 Bottom-Right Corner',
      description: 'Popular for logos!',
    },
    {
      value: 'center',
    ...
    },
    {
      value: 'full',
      label: '📺 Full Overlay',
      description: 'Cover entire video',
    },
  ];
    ...
    <div className="video-maker-container">
      <div className="video-maker-header">
        ...
        <p className="subtitle">
          Advanced AI video creation with psychological multi-perspective
          analysis ✨
        </p>
      </div>
      ...
      {activeTab === 'personalities' && (
        <div className="personalities-showcase">
          <div className="showcase-intro">
            ...
            <p>
              Each personality brings unique expertise and perspective to every
              task:
            </p>
          </div>
              ...
              >
                ...
                >
                  ...
                  <div className="personality-title">
                    <h4 style={{ color: personality.color }}>
                      {personality.name}
                    </h4>
          ...
          <div className="collaboration-info">
            ...
            <div className="collaboration-grid">
              <div className="collaboration-item">
                ...
                <strong>Rapid Tasks:</strong> Neko-Arc leads with enthusiastic
                execution
              </div>
              <div className="collaboration-item">
                <span className="collaboration-icon">🎭</span>
                <strong>Puppeteer Automation:</strong> Mario Gallo Bestino
                provides theatrical documentation
              </div>
              <div className="collaboration-item">
                <span className="collaboration-icon">🗡️</span>
                <strong>Debugging Sessions:</strong> Noel delivers precise
                analysis
              </div>
              <div className="collaboration-item">
                <span className="collaboration-icon">🎸</span>
                <strong>Ethical Reviews:</strong> Glam Americano provides street
                wisdom (in Spanish!)
              </div>
              <div className="collaboration-item">
                <span className="collaboration-icon">🧠</span>
                <strong>Forensic Analysis:</strong> Dr. Hannibal Lecter conducts
                clinical examination
              </div>
              <div className="collaboration-item">
                <span className="collaboration-icon">🎭🧠</span>
                <strong>Complex Identity Problems:</strong> Tetora offers
      ...
      {activeTab === 'abilities' && (
        <div className="abilities-showcase">
          <div className="showcase-intro">
            ...
            <p>
              Our unique multi-personality system creates videos like no other
              AI:
            </p>
          </div>
          ...
          <div className="rule-318-highlight">
            ...
            <div className="rule-content">
              <p>
                Unlike traditional single-voice narration, our{' '}
                <strong>IMMUTABLE Rule 3.18</strong> ensures:
              </p>
              <ul>
                <li>
                  ✅ ALL 6 personalities comment on EVERY frame simultaneously
                </li>
                <li>
                  ✅ Complete perspective coverage (enthusiasm + theater +
                  cynicism + street + clinical + fragmented)
                </li>
                <li>
                  ✅ Maximum entertainment value through personality
                  interactions
                </li>
                <li>
                  ✅ No frame goes without full analysis from all viewpoints
                </li>
              </ul>
              <div className="rule-example">
                <strong>Before Rule 3.18:</strong> 12 frames = 12 subtitle lines
                (one personality per frame)
                <br />
                <strong>After Rule 3.18:</strong> 12 frames = 72 subtitle lines
                (6 personalities × 12 frames)
              </div>
            </div>
          </div>
          ...
          <div className="database-integration">
            ...
            <p>
              Every video creation is automatically documented across all
              personality databases:
            </p>
            <div className="database-list">
              <div className="database-item">
                🐾 <strong>neko-defense-system:</strong> Technical execution
                tracking
              </div>
              <div className="database-item">
                🎭 <strong>marionnette-theater:</strong> Artistic performance
                records
              </div>
              <div className="database-item">
                🗡️ <strong>noel-precision-archives:</strong> Quality assurance
                logs
              </div>
              <div className="database-item">
                🎸 <strong>glam-street-chronicles:</strong> Cultural
                authenticity notes
              </div>
              <div className="database-item">
                🧠 <strong>hannibal-forensic-archives:</strong> Psychological
                analysis
              </div>
              <div className="database-item">
                🎭🧠 <strong>tetora-mpd-archives:</strong> Multi-perspective
                documentation
              </div>
            </div>
          </div>
      ...
      {activeTab === 'maker' && (
        <div className="video-maker-tool">
          <div className="tool-intro">
            ...
            <p>
              Combine videos with image overlays - Perfect for threat actor
              exposure and professional content!
            </p>
          </div>
          ...
          {result && (
            <div className="success-banner">
              ...
              <div className="result-info">
                ...
                <p>
                  ⏱️ <strong>Processing Time:</strong> {result.processingTime}
                </p>
                <p>
          ...
          <form onSubmit={handleSubmit} className="video-maker-form">
            ...
            <div className="form-actions">
              <button
                ...
                disabled={
                  processing || !videoFile || !imageFile || !outputName.trim()
                }
              >
                {processing
                  ? '⏳ Creating Video with MAXIMUM NEKO POWER...'
                  : '✨ Create Video! ✨'}
              </button>
