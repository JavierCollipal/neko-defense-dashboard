  ...
  try {
    ...
    const portMismatchPattern = {
      ...
      root_cause: {
        ...
        technical_detail:
          'React app components hardcoded to PORT 4000 (NestJS API without required endpoints) instead of PORT 5001 (Express API with all endpoints)',
        affected_components: [
          'App.js',
          'ThreatActors.js',
    ...
    const apiFallbackPattern = {
      ...
      root_cause: {
        ...
        technical_detail:
          'Components fetch data from API but have no timeout, no error handling, and no fallback data when API is unavailable or slow',
    ...
    const investigationReport = {
      ...
      initial_report: {
        description:
          'User reported two issues: (1) Cannot see threat actor connections, (2) DINA perpetrators render intermittently',
        urgency: 'HIGH',
        affected_systems: [
      ...
      investigation_phases: [
        {
          ...
          findings:
            'Components configured to use PORT 4000, but server has different capabilities on different ports',
        },
        {
          phase: 2,
          ...
          findings:
            'PORT 4000 (NestJS) returns 404 for /api/threat-actors. PORT 5001 (Express) has ALL required endpoints and data!',
        },
        {
          phase: 3,
      ...
      files_modified: [
        ...
        },
        {
          ...
          changes:
            'Updated API_URL to PORT 5001, added timeout, added fallback logic, added comprehensive error handling',
        },
      ],
